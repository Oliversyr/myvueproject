...
export function getPropertyComList(obj) {
    ...
    return fetch({
        method: 'POST',
        url: '/business/property/company/list',
        data: param
    })
}
...
export function getPropertyProList(obj) {
    ...
    return fetch({
        method: 'POST',
        url: '/business/property/agreement/list',
        data: param
    })
}
...
export function checkProtocol(sheetIds) {
    return fetch({
        method: 'GET',
        url: '/business/property/audit?objectids=' + sheetIds + '&status=1'
    })
}
...
export function deleteProtocol(sheetIds) {
    return fetch({
        method: 'GET',
        url: '/business/property/delete?objectids=' + sheetIds
    })
}
...
export function stopProtocol(sheetIds) {
    return fetch({
        method: 'GET',
        url: '/business/property/stop?objectids=' + sheetIds
    })
}
...
export function getProtocolTip(type) {
    return fetch({
        method: 'GET',
        url: '/business/property/tip?type=' + type
    })
}
