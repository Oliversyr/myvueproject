        ...
        <div class="slic-head-panel">
            ...
            <div style="float: right;">
                <span class="sl-content-handle-left">
                    <el-button-group>
                        <excel-import-export v-if="myModulePower.export" ref="expImp" :fileName="'店铺商品销售'" :header="gridCol" @getResultArr="importData" @goToExp="doExport" :exportData="expData" :isImport="false"></excel-import-export>
                    </el-button-group>
                </span>
            </div>
    ...
    mounted: function() {
        this.$nextTick(function() {
            ...
            this.gridCol = [
                ...
                { field: 'saleMoney', name: '销售金额', minWidth: '100' },
                { field: 'sheetCount', name: '客单数', minWidth: '100' },
                { field: 'sheetPrice', name: '客单价', minWidth: '100' },
            ...
            getGoodsummaryList(params).then((res) => {
                ...
                if (res.retCode === 'SUCCESS') {
                    ...
                    this.gridVal.rows.map((row)=>{
                        row.goodStr = `【${row.goodsId}】 ${row.goodsName}`;
