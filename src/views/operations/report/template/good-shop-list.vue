        ...
        <div class="slic-head-panel">
            ...
            <div style="float: right;">
                <span class="sl-content-handle-left">
                    <el-button-group>
                        <excel-import-export v-if="myModulePower.export" ref="expImp" :fileName="'商品店铺销售'" :header="gridCol" @getResultArr="importData" @goToExp="doExport" :exportData="expData" :isImport="false"></excel-import-export>
                    </el-button-group>
                </span>
            </div>
                ...
                <div class="sl-content-handle" style="text-align: left;height: 30px;">
                    <span class="sl-content-handle-right ">
                        <div class=" animated fadeIn sl-table-header sl-amount-panel">
                            <div class="sl-amount-panel-item"> 【{{superiorParam.goodsId}}】 {{superiorParam.goodsName}}</div>
...
import { getShopsummaryList, getGoodsShopsummaryList } from '@/api/operations/report/report';
...
export default {
    ...
    methods: {
        getShopsummaryList(params) {
            this.loading = true;
            getGoodsShopsummaryList(params).then((res) => {
                this.loading = false;
        ...
        goToReportSaledetail(item) {
            let param = {
                ...
                myGoodsId: this.$route.query.myGoodsId,
                eid: item.eid,
                ename: item.ename,
